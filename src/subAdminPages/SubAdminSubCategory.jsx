...
import SubCategoryModal from "../component/admin/pages/subCategory/SubCategoryModal";
import useSubCategory from "../component/admin/pages/subCategory/useSubCategory";
import SubSubCategoryTableView from "./SubSubCategoryTableView";
import SubAdminSubCategoryTreeView from "./SubAdminSubCategoryTreeView";

const SubAdminSubCategory = () => {
  const {
    subCategories,
    categories,
    loading,
...
export default SubAdminSubCategory;
